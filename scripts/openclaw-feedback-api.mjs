...
const DEFAULT_DIR = 'data/posthog-growth-engineer/feedback-api';
...
PostHog Growth Feedback API

Usage:
  node scripts/openclaw-feedback-api.mjs [--host 127.0.0.1] [--port 4310] [--dir data/posthog-growth-engineer/feedback-api]
